...
namespace TKS_Thuc_Tap_V11_Data_Access.Controller.DM
{
    public class CDM_Nhap_Kho_Controller
    {
        ...
        public List<CDM_Nhap_Kho> FQ_718_NK_sp_sel_List_By_Created(DateTime? p_dtmFrom, DateTime? p_dtmTo)
        {
        ...
        public List<CDM_Nhap_Kho> FQ_718_NK_sp_sel_List_For_Cache()
        {
            List<CDM_Nhap_Kho> v_arrRes = new List<CDM_Nhap_Kho>();
            DataTable v_dt = new DataTable();
            ...
            try
            {
                CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "FQ_718_NK_sp_sel_List_For_Cache");
        ...
        public CDM_Nhap_Kho FQ_718_NK_sp_sel_Get_By_ID(long p_iID)
        {
        ...
        public long FQ_718_NK_sp_ins_Insert(CDM_Nhap_Kho p_objData)
        {
        ...
        public long FQ_718_NK_sp_ins_Insert(SqlConnection p_conn, SqlTransaction p_trans, CDM_Nhap_Kho p_objData)
        {
            long v_iRes = CConst.INT_VALUE_NULL;
        ...
        public void FQ_718_NK_sp_upd_Update(CDM_Nhap_Kho p_objData)
        {
            try
            {
        ...
        public void FQ_718_NK_sp_upd_Update(SqlConnection p_conn, SqlTransaction p_trans, CDM_Nhap_Kho p_objData)
        {
            try
            {
